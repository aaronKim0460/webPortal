...
<!--login form end-->	        
	...
	<!-- my account (show after login)-->
	        ...
	        <div class="account_menu" id="my_name" hidden="hidden">
				<ul>
			      	 <li class="active sub">
                     	<a href="#" title="Alanis Morissette Long Name (Broker)">Alanis Morissette Long Name (Broker)<br/>(AmWest Funding Corp)</a>
							<ul>
								<li class='sub' style="height:58px;">
									 <a href="#" style="height:58px;line-height:1.5; padding-top:10px;" title="Alanis Morissette Long Name (Broker)"><b>Alanis Morissette Long Name (Broker)</b><br>Broker Manager</a>
								</li>
								<li class='sub'>
